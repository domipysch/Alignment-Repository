...
def dot_align_data(dataset_folder: str, mode: str, mapping_mode: str, cell_type_key: str, output_path: str):
    """
    ...
    """
    cmd = [_find_rscript(), R_SCRIPT, dataset_folder, mode, mapping_mode, cell_type_key, output_path]
...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--mode", default="HSO", choices=["LSO", "HSO"], help="Resolution mode")
    parser.add_argument("--mapping", default="deterministic-mapping",
                        choices=["deterministic-mapping", "probabilistic-mapping"], help="Mapping mode")
    parser.add_argument("-k", "--cell-type-key", default="cellID",
    ...
    dot_align_data(args.dataset, args.mode, args.mapping, args.cell_type_key, args.output)
